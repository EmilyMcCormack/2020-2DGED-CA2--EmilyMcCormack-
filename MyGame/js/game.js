...
const cueArray = [
  ...
  new AudioCue("jump", 1, 1, false, 0),
  new AudioCue("pickup", 1, 1, false,0)
...
function LoadEnemySprites() {
    ...
    //step 3 - create transform and use bounding box from initial take (this is why we make AnimatedSpriteArtist before Transform2D)
    let transform = new Transform2D(
      SpriteData.ENEMY_SPRITE_START_LOCATION,
      0,
      Vector2.One,
      Vector2.Zero,
      artist.GetSingleFrameDimensions("enemySprite"),
      0
    );
